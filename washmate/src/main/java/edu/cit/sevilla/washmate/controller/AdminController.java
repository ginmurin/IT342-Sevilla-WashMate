...
import edu.cit.sevilla.washmate.dto.UserDTO;
...
public class AdminController {
    ...
    public ResponseEntity<UserDTO> updateUserWallet(
        ...
        edu.cit.sevilla.washmate.entity.Wallet wallet = walletRepository.findByUserUserId(userId)
                .orElseGet(() -> {
                    edu.cit.sevilla.washmate.entity.Wallet newWallet = new edu.cit.sevilla.washmate.entity.Wallet();
