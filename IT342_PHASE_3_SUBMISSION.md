...
**Commit:** `e523e36 - IT342 Phase 3 – Web Main Feature Completed`

---

## 2. Main Feature: Payment System Integration

The main feature implemented is a **Polymorphic Payment System** that enables users to pay for orders, subscriptions, and wallet top-ups using multiple payment methods through a unified backend API and PayMongo gateway integration.
