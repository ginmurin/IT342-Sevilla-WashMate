...
const menuItems: Record<UserRole, MenuItem[]> = {
  ...
  SHOP_OWNER: [
    { icon: LayoutDashboard, label: 'Shop Dashboard', path: '/shop' },
    { icon: Package, label: 'Shop Orders', path: '/shop/orders' },
    { icon: Wrench, label: 'Shop Services', path: '/shop/services' },
    { icon: Crown, label: 'Subscription', path: '/shop/subscriptions' },
